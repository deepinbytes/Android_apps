...
public class PDFViewAct extends Activity implements PDFLayoutListener
{
    ...
    private static int lastcoordinate_x=0;
    private static int lastcoordinate_y=0;
	...
	public void OnPDFSelectEnd(String text)
	{
		...
		final RadioGroup rad_group = (RadioGroup)layout.findViewById(R.id.rad_group);
		 String sel_text = text;
if(sel_text!=null) {
    invokePopup(sel_text);
 //   invokeWebScraping(sel_text)
};
    ...
    public void invokePopup(String stext)
    {
        //int a =10;
        ...
        popupWindow = new PopupWindow(
                ...
                LinearLayout.LayoutParams.WRAP_CONTENT);
        TextView test= (TextView)popupView.findViewById(R.id.searchtextpopup);
        TextView selectedtext= (TextView)popupView.findViewById(R.id.searchtext);
        popupWindow.showAtLocation(this.m_layout, Gravity.TOP | Gravity.LEFT, lastcoordinate_x, lastcoordinate_y);
        ...
        if(stext.contains(" ")){
            ...
            String[] data = getMeaningfromGoogle(stext);
